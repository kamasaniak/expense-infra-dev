module "mysql_sg" {
    source = "git::https://github.com/kamasaniak/terraform-aws-securitygroup.git?ref=main"
    project_name = var.project_name
    environment = var.environment
    sg_name = "mysql"
    sg_description = "crated for MYSQL instences in expense dev"
...
module "backend_sg" {
    ...
    environment = var.environment
    sg_name = "backend"
    sg_description = "crated for backend instences in expense dev"
    vpc_id = data.aws_ssm_parameter.vpc_id.value
    common_tags = var.common_tags
}
...
module "frontend_sg" {
    ...
    environment = var.environment
    sg_name = "frontend"
    sg_description = "crated for frontend instences in expense dev"
    vpc_id = data.aws_ssm_parameter.vpc_id.value
    common_tags = var.common_tags
}
